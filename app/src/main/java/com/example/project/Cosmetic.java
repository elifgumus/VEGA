...
public class Cosmetic extends AppCompatActivity implements productsRecyclerAdapter.onProductClicked {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.cosmetics_Rv);
    ...
    private void getProducts(){
        try {
            ...
            productsInfo = pHelper.getProductsByType("Cosmetics");
            productsInfo1 = pHelper.getProductsByType("cosmetics");
