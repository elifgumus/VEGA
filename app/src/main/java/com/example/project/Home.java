...
public class Home extends AppCompatActivity implements productsRecyclerAdapter.onProductClicked {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.homeandlife_Rv);
    ...
    private void getProducts(){
        try {
            ...
            productsInfo = pHelper.getProductsByType("Home and life");
            productsInfo1 = pHelper.getProductsByType("home and life");
