...
public class Market extends AppCompatActivity implements productsRecyclerAdapter.onProductClicked{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.market_Rv);
    ...
    private void getProducts(){
        try {
            ...
            productsInfo = pHelper.getProductsByType("Market");
            productsInfo1 = pHelper.getProductsByType("market");
