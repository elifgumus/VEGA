...
public class Electronic extends AppCompatActivity implements productsRecyclerAdapter.onProductClicked{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.electronic_Rv);
    ...
    private void getProducts(){
        try {
            ...
            productsInfo = pHelper.getProductsByType("Electronics");
            productsInfo1 = pHelper.getProductsByType("electronics");
